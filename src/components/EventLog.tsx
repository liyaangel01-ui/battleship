  ...
  return (
    <section className="border border-edge bg-ink px-4 py-2">
      ...
      <details className="mt-1">
        <summary className="cursor-pointer text-[0.65rem] tracking-[0.2em] text-fog uppercase">
          Battle log — {entries.length} {entries.length === 1 ? 'shot' : 'shots'}
        </summary>
        <ol className="mt-2 flex max-h-40 flex-col gap-1 overflow-y-auto text-xs text-fog">
